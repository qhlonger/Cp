...
@implementation LotteryHistoryHeaderCell
...
- (void)layout{
    ...
    [self.iconView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(self.bgView).multipliedBy(0.4);
        make.width.equalTo(self.iconView.mas_height).multipliedBy(1.4);
    }];
